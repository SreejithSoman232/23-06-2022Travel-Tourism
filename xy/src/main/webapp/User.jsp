				...
				<div class="courses">
					<div class="owl-one owl-carousel">
						<div class="box-wrap" itemprop="event" itemscope itemtype=" http://schema.org/Course">
							<div class="img-wrap" itemprop="image"><img src="images/family-tour-packages.jpg" alt="packages picture"></div>
								<a href="#" class="learn-desining-banner" itemprop="name">Family Package </a>
							<div class="box-body" itemprop="description">
								...
								<section itemprop="time">
									...
									<p><span>Fee:</span> 10000 per person </p>
								</section>
							</div>
						</div>

						<div class="box-wrap" itemprop="event" itemscope itemtype=" http://schema.org/Course">
							<div class="img-wrap"  itemprop="image"><img src="images\Adventure.jpg" alt="packages picture"></div>
								<a href="#" class="learn-desining-banner" itemprop="name">Adventure Package</a>
							<div class="box-body" itemprop="description">
								...
								<section itemprop="time">
									<p><span>Duration:</span>5 Days</p>
									<p><span>Fee:</span>15000</p>
								</section>
							</div>
						</div>

						<div class="box-wrap" itemprop="event" itemscope itemtype=" http://schema.org/Course">
							<div class="img-wrap"  itemprop="image"><img src="images/Luxury.jpeg" alt="packages picture"></div>
								<a href="#" class="learn-desining-banner" itemprop="name">Luxury Package</a>
							<div class="box-body" itemprop="description">
								<p>“When preparing to travel, lay out all your clothes and all your money. Then take half the clothes and twice the money.”</p>
								<section itemprop="time">
									<p><span>Duration:</span> 5 Days</p>
									<p><span>Fee:</span> 200000</p>
								</section>
							</div>
						</div>

						<div class="box-wrap" itemprop="event" itemscope itemtype=" http://schema.org/Course">
							<div class="img-wrap"  itemprop="image"><img src="images/Honeymoon.jpg" alt="packges picture"></div>
								<a href="#" class="learn-desining-banner" itemprop="name">Honeymoon Packges</a>
							<div class="box-body" itemprop="description">
								<p>The best things in life are the people we love, the places we’ve been, and all the memories we’ve made along the way.”</p>
								<section itemprop="time">
									<p><span>Duration:</span>5 Days</p>
									<p><span>Fee:</span>18000</p>
								</section>
							</div>
						</div>
					</div>
		...
		<section class="whyUs-section">
			<div class="container">
				<div class="featured-points">
					<ul>
						<li><i class="fas fa-book"></i> Best in the industry</li>
						<li><i class="fas fa-money-check-alt"></i> Affordable Packages</li>
						<li><i class="fas fa-chalkboard-teacher"></i> Experienced Guides</li>
						<li> <i class="fas fa-book"></i> Best Offers</li>
					</ul>
				</div>
				<div class="whyus-wrap">
					<h1>why us?</h1>
					<p itemprop="description"> India's leading online travel company, has a profound understanding of Indian consumers travel needs and preferences. It offers a wide range of holiday packages in India and across the world, catering to various segments of travelers. thus ensuring there is something to meet the holiday needs of every kind of traveller.</p>
			...
			<div class="container">
				<div class="event-wrap">
					<div class="img-wrap" itemprop="image">
						<img src="images/Manali.jpg" alt="event images">
					</div>
					<div class="details">
						<a href=""><h3 itemprop="name">Manali Trip 15% OFF</h3></a>
						<p itemprop="description">10 Day Manali Trip 15% OFF</p>

						<h5 itemprop="startDate"><i class="far fa-clock"></i> Dec 23,2022</h5>
				...
				<div class="event-wrap">
					<div class="img-wrap" itemprop="image">
						<img src="images/kashmir.jpg" alt="event images">
					</div>
					<div class="details">
						<a href=""><h3 itemprop="name">Kashmir trip 15% OFF</h3></a>
						<p itemprop="description">10 Day Kashmir Trip 15% OFF</p>
						...
						<div class="border">
							...
							<div class="customer-review">
								<p itemprop="description">
									"Great service. Organized very well. Amazing trip and great recommendation regarding dates and location. I would book again with travelN. Nearly everything went smoothly and we were happy with the service.

Just some feedback:
- I wasn't aware of the meal package on the island - i would have liked more information regarding this before we left.
- Long timeframe for response to emails. Over 2 days which i found frustrating.
- Our taxi from airport to boat was part of the package, but it wasn't made clear that the return taxi from boat to the airport was not pre-booked for us. We were stuck for a while at 6am after the boat dropped us from Cast away to find a taxi to get to the airport. This should either have been pre-booked, or communicated to us that we would need to organize this"
								</p>
							</div>
						</div>
					</div>
...
- I wasn't aware of the meal package on the island - i would have liked more information regarding this before we left.
- Long timeframe for response to emails. Over 2 days which i found frustrating.
- Our taxi from airport to boat was part of the package, but it wasn't made clear that the return taxi from boat to the airport was not pre-booked for us. We were stuck for a while at 6am after the boat dropped us from Castaway to find a taxi to get to the airport. This should either have been pre-booked, or communicated to us that we would need to organize this"
								</p>
							</div>
						</div>
					</div>
			...
			<div class="footer-first-section">
				<div class="container">
					<div class="box-wrap" itemprop="about">
						...
						<p>TravelN is a great platform for traveling. Book tours with 1 click</p>

						<h4><a href="tel:+9779813639131"><i class="fas fa-phone"></i> +977 9813639131</a></h4>
						<h4><a href="mailto:info@educationpro.com"><i class="fas fa-envelope"></i> travelwithus@gmail.com</a></h4>
						<h4><a href=""><i class="fas fa-map-marker-alt"></i>Kottayam, Kerala</a></h4>
					</div>
					<div class="box-wrap">
						<header>
							<h1>quick contact</h1>
